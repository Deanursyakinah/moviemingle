...
while ($row = mysqli_fetch_assoc($query)) {
    ...
    echo "<div style='display: flex; align-items:center;'><img style='width:50px; height:50px; border-radius:50%;' src='imgSignUp/{$data['profile_picture']}' alt=''><h4>{$data['username']}</h4></div>";
