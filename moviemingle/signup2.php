...
<body>
  ...
  if (isset($_POST['username']) && isset($_POST['password']) && isset($_POST['password2']) && isset($_POST['email']) && isset($_FILES['profile_picture'])) {
    ...
    if (mysqli_query($connectToSQL, $sql)) {
      $_SESSION['user_id'] = $ngambilrownya['user_id']; 
      setcookie('username', $ngambilrownya['username'], time() + (3600), '');
      $_SESSION['profile_picture'] = $pfp;
      setcookie('profile_picture', $pfp, time() + (3600), '');
    } else {
  ...
  <div class="container-fluid pt-5">
    <div class="container">
      <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px">
        ...
        <h1 class="display-5 text-white mb-0">Sign Up To Your Account</h1>
      </div>
      <div class="row g-5">
        <div class="col-lg-7">
          <!-- FORM DARI SINI -->
          <form method="POST" action="signup2.php" enctype="multipart/form-data">
            <div class="row g-3">
              ...
              <p>Sudah punya akun ? <a href="signin2.php">klik ini</a></p>
